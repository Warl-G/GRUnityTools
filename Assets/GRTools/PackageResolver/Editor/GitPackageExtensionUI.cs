...
{
    [InitializeOnLoad]
    public class GitPackageExtensionUI : IPackageManagerExtension
    {
        static GitPackageExtensionUI()
        {
            PackageManagerExtensions.RegisterExtension(new GitPackageExtensionUI());
        }
        ...
        private static void Progress()
        {
            if (_request.IsCompleted)
            {
                ...
                {
                    Debug.Log("Importing Success: " + _request.Result.name);
                }
